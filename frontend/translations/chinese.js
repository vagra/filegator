const data = {
  ...
  'Already have an account?': '有账号了?',
  'Successfully registered! Click to': '注册完成! 点击',
  'User Login': '用户登录',
  'User Register': '注册新用户',
  'Only use letters, numbers and underscores': '只能使用 {0}-{1} 位字母、数字和下划线',
  ...
  'Guest': '游客',
  'Cant convert files with this format': '无法转换这种格式的文件',
  'File format cant be recognized': '文件格式无法识别',
  'Help': '帮助',
  'Change Log': '更新历史',
}
